...
TODO step:
1. Create a json file to store client and category
2. Create a main screen with 'Add note' button
3. Create edit note screen with 2 dropdowns: client and category, and 1 multiline text input
4. Create the navigation for pressing 'Add note' button to edit note screen
5. Stroing note data into local storage
6. Read note data from local storage when app is opened, and render it by flatlist
